...
function compute()
{
    ...
    if(principal && parseInt(principal)>0)
    {
        ...
        document.getElementById("result").innerHTML= "If you deposit "+principal+",\<br\> at an interest rate of "+rate+"%\<br\>You will receive an amount of "+final+",\<br\>in the year "+year;
    }
    else
    {
